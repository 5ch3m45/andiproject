...
/**
 * Title: Search
 * Slug: pixetiq/pixetiq-archive
 * Inserter: no
 */
?>

<!-- wp:group {"tagName":"main","align":"full","layout":{"type":"constrained"}} -->
<main class="wp-block-group alignfull"><!-- wp:query-title {"type":"archive","textAlign":"center","align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|50"}}},"fontSize":"forty-px","fontFamily":"Inter"} /-->
...
<div class="wp-block-column"><!-- wp:query {"queryId":51,"query":{"perPage":3,"pages":0,"offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"enhancedPagination":true,"align":"wide","layout":{"type":"default"}} -->
...
<div class="wp-block-buttons" style="margin-top:30px"><!-- wp:button {"textAlign":"center","textColor":"base-2","style":{"color":{"background":"#7f56d9"},"elements":{"link":{"color":{"text":"var:preset|color|base-2"}}},"border":{"radius":"10px","color":"#7f56d9","width":"1px"},"spacing":{"padding":{"left":"18px","right":"18px","top":"12px","bottom":"12px"}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"400","lineHeight":"1.4"}},"fontFamily":"body"} /--></div>
<!-- /wp:buttons --></div>
<!-- /wp:query --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
